      ...
      <div className=" shadow-md rounded-xl p-4">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-gray-800">Maintenance Overview</h2>
          </div>
          <button className="text-blue-600 hover:underline text-sm font-medium flex gap-1 items-center cursor-pointer">
            <CirclePlus className='w-4 h-4'/>New Maintenance Task
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-[#fffbeb] text-yellow-800 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold">{maintenanceData.highPriorityDefects}</p>
          ...
          <div className="bg-[#f0fdf4] text-green-800 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold">{maintenanceData.completedRepairs}</p>
        ...
        <div className="space-y-4">
          {maintenanceData.defects.map((defect) => (
            ...
            >
              <div>
                <h3 className="text-sm font-semibold text-gray-800">{defect.title}</h3>
                <p className="text-sm text-gray-600">{defect.description}</p>
                <p className="text-xs text-gray-400 mt-1">Reported: {defect.reportedAgo}</p>
              </div>
