            ...
            <div className="flex w-full h-full flex-col items-start">
                ...
                <div className='w-full flex flex-col gap-2'>
                    <div className='flex justify-between items-center text-sm text-[#64748b] '>
                        ...
                        <div>{   Math.min((data.data.progress / data.data.total) * 100, 100)}%</div>
                    </div>
                    <ProgressBar currentValue={data.data.progress} totalValue={data.data.total}/>

                </div>
                <TransparentLineChart data={data.data.trendData} color={data.data.status === "Needs attention" ? '#ef4444' : '#22c55e'} />
